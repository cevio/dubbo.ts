import { HEADER_LENGTH, MAGIC_HIGH, MAGIC_LOW, fromBytes4, fromBytes8, getDubboArgumentLength, FLAG_TWOWAY, FLAG_REQEUST, FLAG_EVENT, RESPONSE_STATUS, RESPONSE_BODY_FLAG } from './utils';
