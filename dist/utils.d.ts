...
export declare function ProviderRegisterUri(root: string, host: string, application: string, dubboversion: string, pid: number, options: ProviderInterfaceOptions): {
...
export declare function heartBeatEncode(): Buffer;
